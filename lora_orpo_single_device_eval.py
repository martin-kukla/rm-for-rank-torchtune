...
class LoRAORPORecipeSingleDeviceEval(EvalRecipeInterface):
    """
            ...
            self._metric_logger.log_dict(
                {
                    ...
                    .mean()
                    .cpu(),
                    "log_probs/rejected": avg_rejected_log_probs.detach()
                    .mean()
                    .cpu(),
                    "log_probs/chosen": avg_chosen_log_probs.detach()
                    .mean()
                    .cpu(),
...
def recipe_main(cfg: DictConfig) -> None:
    ...
    """
    config.log_config(recipe_name="LoRAORPORecipeSingleDeviceEval", cfg=cfg)
    recipe = LoRAORPORecipeSingleDeviceEval(cfg=cfg)
